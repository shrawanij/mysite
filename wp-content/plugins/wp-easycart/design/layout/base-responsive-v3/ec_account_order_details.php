...
<div id="ec_account_order_details">
	<div class="right"><a href="<?php echo $this->account_page . $this->permalink_divider; ?>ec_page=print_receipt&order_id=<?php echo $this->order->order_id; ?><?php if( $this->order->guest_key != "" ){ echo '&ec_guest_key=' . $this->order->guest_key; } ?>" target="_blank"><img src="<?php echo $this->get_print_order_icon_url( ); ?>" /></a></div>
	<div class="ec_account_order_details_main_holder">
		...
		<div class="ec_account_order_details_left">
            ...
            <div class="ec_cart_input_row"><strong><?php echo $GLOBALS['language']->get_text( 'cart_billing_information', 'cart_billing_information_vat_registration_number' ); ?>:</strong> <?php echo htmlspecialchars( $this->order->vat_registration_number, ENT_QUOTES ); ?></div>
