...
<?php if( (float) get_option( 'ec_option_minimum_order_total' ) > 0 && (float) get_option( 'ec_option_minimum_order_total' ) > $this->cart->subtotal ){ ?>
<div class="ec_minimum_purchase_box"><p><?php echo $GLOBALS['language']->get_text( 'cart', 'cart_minimum_purchase_amount1' ); ?> <?php echo $GLOBALS['currency']->get_currency_display( get_option( 'ec_option_minimum_order_total' ) ); ?> <?php echo $GLOBALS['language']->get_text( 'cart', 'cart_minimum_purchase_amount2' ); ?></p></div>
<?php }?>
