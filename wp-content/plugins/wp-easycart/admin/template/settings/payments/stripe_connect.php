<div class="ec_admin_stripe_row">
    <div class="ec_admin_slider_row">
        ...
        <div class="ec_admin_slider_row_description">
            <div>Stripe offers the ability to pay with a credit card directly on your website. Adding Stripe gives your shopping cart a more professional look and increases conversions.</div>
            ...
            <div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important;">Currency
            ...
            <div id="stripe_use_ideal" class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important; font-size:12px;<?php if( get_option( 'ec_option_stripe_currency' ) != 'EUR' ){ echo ' display:none;'; } ?>">Enable iDEAL (the most popular payment method in the Netherlands)
                <select name="ec_option_stripe_enable_ideal" id="ec_option_stripe_enable_ideal" onchange="ec_admin_save_stripe_connect_options( );">
                    <option value="1" <?php if( get_option( 'ec_option_stripe_enable_ideal' ) ) echo ' selected'; ?>>Enable iDEAL</option>
                    <option value="0" <?php if( !get_option( 'ec_option_stripe_enable_ideal' ) ) echo ' selected'; ?>>Disable iDEAL</option>
            	</select>
            </div>
            <?php }?>
        ...
        <?php if( get_option( 'ec_option_stripe_connect_sandbox_access_token' ) != '' || get_option( 'ec_option_stripe_connect_production_access_token' ) != '' ){ ?>
        <div class="ec_admin_webhook"><strong>Webhook URL:</strong> <a href="#" onclick="ec_admin_copy_stripe_webhook( ); return false;">Copy Webhook to Clipboard</a></div>
        <div class="ec_admin_webhook_copy" id="stripe_webhook_copied" style="display:none;">Webhook URL has been copied to your clipboard!</div>
        <?php }?>
    </div>
</div>