        ...
        <div class="ec_admin_flex_row">
            <div class="ec_admin_list_line_item ec_admin_col_12 ec_admin_col_first">
                ...
                <div class="ec_admin_settings_label">
                    ...
                    <span><?php if( isset( $_GET['ec_admin_form_action'] ) && $_GET['ec_admin_form_action'] == 'add-new' ){ echo 'ADD NEW'; }else{ echo 'EDIT'; } ?> PER-PAGE VALUE</span>
                    <div class="ec_page_title_button_wrap">
                        <a href="<?php echo wp_easycart_admin( )->helpsystem->print_docs_url('settings', 'manage-per-page', 'details');?>" target="_blank" class="ec_help_icon_link"><div class="dashicons-before ec_help_icon dashicons-info"></div></a>
                ...
                <div class="ec_admin_settings_input ec_admin_settings_currency_section">
                	<div id="ec_admin_row_heading_title" class="ec_admin_row_heading_title">Per-Page Setup<br></div>
                    <div id="ec_admin_row_heading_message" class="ec_admin_row_heading_message"><p>If you offer pagination on your store pages, you can control the various amount of products that will appear on a page.  For example, offer 25, 50, or 100 products per page to the user by simply entering values here that you wish to appear.  The pagination feature must be enabled to use this within the Product settings, under 'Split Products into Record Sets'.</p></div>
