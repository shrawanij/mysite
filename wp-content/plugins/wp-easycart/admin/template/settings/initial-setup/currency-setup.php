<div class="ec_admin_list_line_item ec_admin_demo_data_line">
    ...
    <div class="ec_admin_settings_label"><div class="dashicons-before dashicons-admin-generic"></div><span>Currency Setup</span><a href="<?php echo wp_easycart_admin( )->helpsystem->print_docs_url('settings', 'initial-setup', 'currency');?>" target="_blank" class="ec_help_icon_link"><div class="dashicons-before ec_help_icon dashicons-info"></div></a>
     <?php echo wp_easycart_admin( )->helpsystem->print_vids_url('settings', 'initial-setup', 'currency');?></div>
    ...
    <option value="0" <?php if (get_option('ec_option_currency_symbol_location') == 0) echo ' selected'; ?>>Right</option>
        ...
        <div>Currency Exchange Rates: <input name="ec_option_exchange_rates" id="ec_option_exchange_rates" type="text" value="<?php echo stripslashes(get_option('ec_option_exchange_rates')); ?>" /></div>
    </div>
